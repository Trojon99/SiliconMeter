...
swiftc -O -target arm64-apple-macos13.0 -module-cache-path "$CLANG_MODULE_CACHE_PATH" -import-objc-header app/TelemetryBackend.h .build/main.swift app/HistoryLogger.swift .build/TelemetryBackend.o \
