...
subprocess.run(['swiftc', '-O', '-target', 'arm64-apple-macos13.0', '-module-cache-path',
                ...
                str(ROOT / 'app/HistoryLogger.swift'), str(ROOT / '.build/TelemetryBackend.o'),
...
with tempfile.TemporaryDirectory(prefix='compute-history-') as tmp:
    ...
    with sqlite3.connect(f'file:{db}?mode=ro', uri=True) as c:
        ...
        assert runrow[2] == 1 and runrow[3] and runrow[4] and runrow[5] and runrow[6] > 0 and runrow[7] == 1
